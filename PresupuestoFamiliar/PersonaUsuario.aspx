...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <p>
            <b>Ingresar:</b>Para Ingresar Persona y Usuario llenar todos los campos a excepción del ID y darle al botón registrar.<br />
            <b>Borrar:</b>Para Borrar Persona agregar únicamente el ID y para Usuario agregar el correo.<br />
            <b>Modificar:</b>Para Modificar Persona llenar todos los campos al igual que con modificar Usuario.<br />
            <b>Consultar:</b>Para Consultar Persona agregar únicamente el ID y para consultar Usuario agregar el correo.
        </p>
    </div>
    ...
    <div class="contentplace">
        ...
        <div class="register-style">
            Registrar una nueva persona y usuario,<br />
            llenar campos de Persona y Usuario<br />
